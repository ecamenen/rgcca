      ...
      conditionalPanel(
        ...
        selectInput("analysis_type",
                    ...
                    choices = list(
                      ...
                      `Multiblocks` = c(`Regularized Generalized CCA (RGCCA)` = 'RGCCA', `Sparse Generalized CCA (GCCA)` = 'SGCCA', `SUM of CORrelations method` = 'SUMCOR', `Sum of SQuared CORrelations method` = 'SSQCOR',
